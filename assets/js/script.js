...
const VAULT_DATA = {
  ...
  content: {
    ...
    heroDesc:
      "Industrial-grade software assets designed for absolute performance.",
  ...
  socials: [
    {
      ...
      url: "https://instagram.com/frans_marcellino",
    },
    {
      label: "LINKEDIN",
      icon: "fab fa-linkedin-in",
      url: "https://linkedin.com/in/frans-marcellino",
    },
    {
      label: "EMAIL",
      icon: "fas fa-envelope",
      url: "mailto:fransmarselinosroyer@gmail.com",
    },
  ],
};
...
function init() {
  ...
  document.getElementById("nav-logo").innerHTML =
    `${VAULT_DATA.owner.firstName} <span>${VAULT_DATA.owner.lastName}</span>`;
